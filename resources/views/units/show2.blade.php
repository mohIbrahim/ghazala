	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<ul class="nav nav-pills pull-right">
				<li><a data-toggle="pill" href="#menu3"><strong>المستأجرين</strong></a></li>
				<li><a data-toggle="pill" href="#menu2"><strong>كروت وملصقات الدخول</strong></a></li>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="jumbotron">
									...
									@foreach($unit->owners as $owner)
									@foreach($owner->membershipCardsForIndividual as $membershipCard)
									<div class="panel-body">					
